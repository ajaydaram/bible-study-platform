...
export default function CreedProofsPanel({ reference }: CreedProofsPanelProps) {
    ...
    return (
      <div className="flex flex-col h-full bg-white dark:bg-gray-900 animate-fade-in">
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-955/20 dark:to-purple-955/20">
          ...
          <div className="flex items-center justify-between gap-3 mt-1.5 text-[11px] text-gray-500 dark:text-gray-400">
            <div className="flex items-center gap-2">
              ...
              {documentType && (
                <span className="capitalize px-1.5 py-0.5 rounded bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 font-medium">
                  {documentType}
                </span>
              )}
            </div>
  ...
  if (proofs.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center px-4 space-y-3">
        ...
        <div>
          <p className="text-sm font-medium text-gray-500 dark:text-gray-400">No specific citations for this verse</p>
          <p className="text-xs text-gray-400 mt-1 max-w-[220px]">
            Explore all 49 historic Creeds, Confessions & Catechisms in the library.
          </p>
        </div>
        <Link
          to="/confessions"
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-900">
      {/* Header */}
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-955/20 dark:to-purple-955/20 flex items-center justify-between">
        <div className="flex items-center gap-2">
